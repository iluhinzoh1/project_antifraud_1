...
public class CardController extends AbstractController<SuspiciousCardTransferDto> {
    ...
    @Operation(
            ...
            description = "Сохраняет подозрительную запись по карте"
    )
    @ApiResponses({
    ...
    @PostMapping
    public ResponseEntity<SuspiciousCardTransferDto> create(@Valid @RequestBody
    ...
    @Operation(
            ...
            description = "Изменяет подозрительную запись по карте"
    )
    @ApiResponses({
    ...
    @Operation(
            ...
            description = "Удаляет подозрительную запись по карте"
    )
    @ApiResponses({
    ...
    @Operation(
            ...
            description = "Получает подозрительные записи по карте"
    )
    @ApiResponses({
    ...
    @GetMapping
    public List<? extends SuspiciousCardTransferDto> getAll() {
        return super.getAll();
    }
    ...
    @Operation(
            ...
            description = "Получает подозрительную запись по карте"
    )
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Запись получена"),
            @ApiResponse(responseCode = "204", description = "Нету данных"),
    ...
    @GetMapping("/{id}")
    public ResponseEntity<SuspiciousCardTransferDto> getById(
            @PathVariable Long id) {
